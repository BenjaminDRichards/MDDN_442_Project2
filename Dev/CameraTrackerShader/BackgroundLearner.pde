...
// This class learns the background and picks out objects moving against it.
{
  ...
  BackgroundLearner(Capture cam)
  {
    ...
    // Load shaders
    shader_inputBlur = loadShader("tex_inputBlur.frag.glsl", "tex.vert.glsl");
    shader_stripAlpha = loadShader("tex_stripAlpha.frag.glsl", "tex.vert.glsl");
    shader_maskFromBG = loadShader("tex_maskFromBG.frag.glsl", "tex.vert.glsl");
    shader_mult = loadShader("tex_mult.frag.glsl", "tex.vert.glsl");
    shader_addWhite = loadShader("tex_addWhite.frag.glsl", "tex.vert.glsl");
    shader_buildHeatIso = loadShader("tex_buildHeatIso.frag.glsl", "tex.vert.glsl");
